...
Current status — 24 September 2026: [the checkpoint review](08-checkpoint-review.md) covers `3c6b431` and its reproduced F13–F15 failures. [C03a](../handoffs/C03a.md) closes remapped table confirmation and loaded-checkpoint continuation. [C04's resumed pass](../handoffs/C04.md#resumed-layout-pass--24-september-2026) moves reef objectives out of real colliders, shortens the pier, composes actual seating pools, clears all 300 occupied pickup rays/collider overlaps, and exercises one controller-driven lounge approach plus normal placement/throw under content `beach-content-7`; other on-foot approaches and full visual acceptance remain open. Next: finish C04, then C05–C09 under the [completion plan](07-completion-plan.md). Final visuals and release evidence remain open.

The baseline commit contains project-owned implementation; licensed Synty source and generated staged art remain local and require the C00 staging steps. The committed requirements include the confirmed 160 m layout and current access-purchase prerequisites. [C04's checkpoint](../handoffs/C04.md) includes grouped destinations, structural reef geometry and the working paired-capture option. Its visual rubric remains incomplete. Keep `601cee3` for C03-era content-5 saves and `3c6b431` for content-6 saves before this follow-up's deterministic manifest change.
