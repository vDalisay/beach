...
The [systems review](10-systems-review.md) records what is implemented and what remains unverified. The [C-packet specifications](07-completion-plan.md) retain supporting detail. The revised [look-and-feel specification](09-reference-look-plan.md), including **all V00–V07**, is incorporated into FIN-06–FIN-08, with final hardware acceptance in FIN-10. These are supporting documents, not separate backlogs.
