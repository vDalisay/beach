...
5. Emit affected IDs/home sections and wallet change; P20 updates totals/restoration. Request save after the commit; P24 later makes that request persistent. Snapshot before/after remains internally consistent.
