...
3. Author a beach about one quarter of the previous 640 m length (roughly 160 m); do not tune it to the superseded 180-second walk target. Verify end-to-end traversal, all hut doors and pier access with the player's large carry pose. Add clear non-enterable backdrop boundaries and recoverable ocean/underside bounds.
