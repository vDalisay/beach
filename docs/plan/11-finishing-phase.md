...
**This is the active execution list for finishing the game.** The major gameplay systems already exist. What remains is two known control repairs, completion of integrated play/device evidence, world and asset finishing, the new rendering implementation, and final release verification. Completed P/C work is not a second backlog. The V packets below are included here; their exact shader/resource instructions stay in the look-and-feel specification.
