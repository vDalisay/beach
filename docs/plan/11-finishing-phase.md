...
- [ ] **FIN-02 — Close physical access, storage and content compatibility.** Current bounded recheck: [C04](../handoffs/C04.md) and [C05](../handoffs/C05.md). A normal-input shore-to-reef pickup and return now passes on starter air. Connected walking approaches to every occupied slot and player-paced access remain open. The [beach terrain pass](15-beach-terrain-pass.md) changed generation: content 9, with the reef rock and seagrass exclusions now in the content identity. Keep `768070b` for content-8 saves; world, traversal, rescue, faint and 100-seed rechecks pass ([B-beach](../handoffs/B-beach.md)).
